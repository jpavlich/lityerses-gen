...
//CUANDO TIENE DATATABLE Se reemplaza todo de cada en adelante
    ...
    private class AttractionAdapter extends RecyclerView.Adapter<ViewHolder>   implements ItemClickListener {
        ...
        public void onBindViewHolder(ViewHolder holder, int position) {
            ...
            holder.mTitleTextView.setText(dieta.getNombre());                          //Atributos asignados en el for
            holder.mDescriptionTextView.setText(dieta.getDesayuno());
            holder.mtext3.setText(dieta.getAlmuerzo());
            holder.mtext4.setText(dieta.getCena());
            holder.mtext5.setText(dieta.getMerienda());
            holder.mtext6.setText(dieta.getId() + "");
        }
        @Override
