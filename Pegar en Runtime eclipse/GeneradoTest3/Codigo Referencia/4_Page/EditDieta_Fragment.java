    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dieta.nombre = text0.getText()+"";       //componentes visuales EditText
                dieta.desayuno = text1.getText()+"";
                dieta.almuerzo = text2.getText()+"";
                dieta.cena = text3.getText()+"";
                dieta.merienda = text4.getText()+"";
                dieta.patologia = Integer.parseInt(text5.getText()+"");
